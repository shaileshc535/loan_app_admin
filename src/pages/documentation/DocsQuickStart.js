          ...
          <Card.Body>
            <article>
              ...
              <p className="fs-5 fw-light">
                This guide will help you get started with Volt React Dashboard
              </p>
              ...
              <p>
                Please follow these steps to install the required technologies:
              </p>
              ...
              <ol className="ps-4 docs-list">
                ...
                <li>
                  <p>
                    After installing yarn, open a terminal and run{" "}
                    <code>yarn install</code> in the main <code>volt</code>{" "}
                    folder to download all project dependencies.
                  </p>
                  <Code code="$ yarn install" language="bash" />
                </li>
                <li>
                  <p>
                    Then start the app in development mode by running the
                ...
                <li>
                  Open{" "}
                  <Card.Link href="http://103.145.51.109:3000" target="_blank">
                    http://103.145.51.109:3000
                  </Card.Link>{" "}
                  to view it in the browser.
                </li>
              </ol>

              <h2 className="fs-5 mt-4" id="using-npm">
                Using <code>npm</code>
              </h2>
              <ol className="ps-4 docs-list">
                <li>
                  Install Node.js from{" "}
                  <Card.Link href="https://nodejs.org/" target="_blank">
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    node.js version manager (nvm for short)
                  </a>
                  .
                ...
                <li>
                  <p>
                    ...
                    <code>npm install</code> in the main <code>volt</code>{" "}
                    folder to download all project dependencies. You'll find
                    them in the <code>node_modules</code> folder.
                  </p>
