...
function JobRiderUpdate({ id, showChange }) {
  ...
  useEffect(() => {
    dispatch(loadSingleJobRider(id));
  }, []);

  const jobRider = useSelector((state) => state.jobRider.singledata);
  ...
  const handleSubmit = (e) => {
    ...
    if (!driver_id || !vehicle_id) {
      ...
      dispatch(updateJobRider(id, state));
      showChange();
    }
  };
