...
const PaymentFindAll = () => {
  ...
  const paymentDetails = useSelector((state) => state.paymentDetails.result);
  const paymentDetail = useSelector((state) => state.paymentDetails);
  let { error, loading } = paymentDetail;
  ...
  const pages = [];
  for (let i = 1; i <= Math.ceil(paymentDetails.length / itemsPerPage); i++) {
    pages.push(i);
  }
  ...
  if (add === true) {
    var detail = <PaymentCreate showChange={showChange} />;
  } else if (update === true) {
    detail = <PaymentUpdate id={id} showChange={showChange} />;
  } else {
    detail = (
                  ...
                  <div className="col-12">
                    <div className="card">
                      <div className="card-header">
                        <h4 className="card-title">Payment Type Details</h4>
                      </div>
                      <Table
                        id="datatable"
