...
const DriverPayments = ({ showChange }) => {
  ...
  const PaymentDeatils = useSelector(
    (state) => state.PaymentDeatils.driverResult
  );
                ...
                <div className="col-12">
                  <div className="card">
                    <div className="card-header">
                      <h4 className="card-title">Driver Payment History</h4>
                    </div>
                    <Table
                      id="datatable"
